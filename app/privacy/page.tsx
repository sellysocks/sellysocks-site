  ...
  return (
    <div className="min-h-screen bg-cream-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-serif font-bold text-brown-900 mb-2">Privacy Policy</h1>
          ...
          <Card>
            ...
            <CardContent>
              <p className="text-brown-700">
                ...
                <a href="mailto:privacy@sellysocks.com" className="text-brown-900 hover:underline">
