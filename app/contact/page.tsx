        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Have a question, concern, or feedback? We're here to help and would love to hear from you.
            </p>
          </div>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Your privacy is important to us. All communications are confidential and we never share your
